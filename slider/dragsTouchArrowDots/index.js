const GalleryClassName = 'gallery',
      ...
      GalleryLeftClassName = 'btn-left',
      GalleryRightClassName = 'btn-right',
      GalleryNavDisabledClassName = 'gallery-arrows-disabled';
    ...
    manageHTML() {
        ...
        this.containerNode.innerHTML = `
            ...
            <div class="${GalleryArrowsClassName}">
                <button class="${GalleryLeftClassName}">left</button>
                <button class="${GalleryRightClassName}">right</button>
            </div>
        ...
        this.navLeft = this.containerNode.querySelector(`.${GalleryLeftClassName}`);
        this.navRight = this.containerNode.querySelector(`.${GalleryRightClassName}`);
    }

    setParameters() {
        this.width = this.lineContainerNode.getBoundingClientRect().width;
